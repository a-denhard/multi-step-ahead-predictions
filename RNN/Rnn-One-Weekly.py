...
for i in range(3, len(weekly_averages)):
  ...
  if (i==0):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-NREL-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-NREL-weekly.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-NREL-weekly.txt', metrics,  delimiter = ' ')
  elif(i==1):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-ARM-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-ARM-weekly.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-ARM-weekly.txt', metrics,  delimiter = ' ')
  elif(i==2):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-BON-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-BON-weekly.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-BON-weekly.txt', metrics,  delimiter = ' ')
  elif(i==3):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-DRA-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-DRA-weekly.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-DRA-weekly.txt', metrics,  delimiter = ' ')
  elif(i==4):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-FPK-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-FPK-weekly.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-FPK-weekly.txt', metrics,  delimiter = ' ')
  elif(i==5):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-GWN-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-GWN-weekly.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-GWN-weekly.txt', metrics,  delimiter = ' ')
  elif(i==6):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-PSU-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-PSU-weekly.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-PSU-weekly.txt', metrics,  delimiter = ' ')
  elif(i==7):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-SXF-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-SXF-weekly.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-SXF-weekly.txt', metrics,  delimiter = ' ')
  elif(i==8):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-TBL-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-TBL-weekly.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-TBL-weekly.txt', metrics,  delimiter = ' ')
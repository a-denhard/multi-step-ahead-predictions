...
for i in range(len(daily_averages)):
  ...
  if (i==0):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-NREL-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-NREL-daily.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-NREL-daily.txt', metrics,  delimiter = ' ')
  elif(i==1):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-ARM-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-ARM-daily.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-ARM-daily.txt', metrics,  delimiter = ' ')
  elif(i==2):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-BON-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-BON-daily.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-BON-daily.txt', metrics,  delimiter = ' ')
  elif(i==3):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-DRA-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-DRA-daily.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-DRA-daily.txt', metrics,  delimiter = ' ')
  elif(i==4):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-FPK-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-FPK-daily.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-FPK-daily.txt', metrics,  delimiter = ' ')
  elif(i==5):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-GWN-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-GWN-daily.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-GWN-daily.txt', metrics,  delimiter = ' ')
  elif(i==6):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-PSU-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-PSU-daily.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-PSU-daily.txt', metrics,  delimiter = ' ')
  elif(i==7):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-SXF-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-SXF-daily.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-SXF-daily.txt', metrics,  delimiter = ' ')
  elif(i==8):
    model_rnn.save('/wendianHome/bins/adenhard/one-step/models/RNN-TBL-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/RNN-TBL-daily.txt', predicted_RNN, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/RNN-TBL-daily.txt', metrics,  delimiter = ' ')

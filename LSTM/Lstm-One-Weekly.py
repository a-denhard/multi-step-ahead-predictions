...
for i in range(2, len(weekly_averages)):  
  # LSTM
  tic()
  ...
  if (i==0):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-NREL-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-NREL-weekly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-NREL-weekly.txt', metrics,  delimiter = ' ')
  elif(i==1):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-ARM-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-ARM-weekly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-ARM-weekly.txt', metrics,  delimiter = ' ')
  elif(i==2):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-BON-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-BON-weekly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-BON-weekly.txt', metrics,  delimiter = ' ')
  elif(i==3):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-DRA-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-DRA-weekly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-DRA-weekly.txt', metrics,  delimiter = ' ')
  elif(i==4):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-FPK-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-FPK-weekly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-FPK-weekly.txt', metrics,  delimiter = ' ')
  elif(i==5):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-GWN-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-GWN-weekly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-GWN-weekly.txt', metrics,  delimiter = ' ')
  elif(i==6):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-PSU-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-PSU-weekly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-PSU-weekly.txt', metrics,  delimiter = ' ')
  elif(i==7):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-SXF-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-SXF-weekly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-SXF-weekly.txt', metrics,  delimiter = ' ')
  elif(i==8):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-TBL-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-TBL-weekly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-TBL-weekly.txt', metrics,  delimiter = ' ')
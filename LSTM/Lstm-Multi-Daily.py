...
for i in range(6, len(daily_averages)):
  # LSTM
  tic()
  ...
  if (i==0):
    model_lstm.save('/wendianHome/bins/adenhard/multi-step/models/LSTM-NREL-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/LSTM-NREL-daily.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/LSTM-NREL-daily.txt', metrics,  delimiter = ' ')
  elif(i==1):
    model_lstm.save('/wendianHome/bins/adenhard/multi-step/models/LSTM-ARM-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/LSTM-ARM-daily.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/LSTM-ARM-daily.txt', metrics,  delimiter = ' ')
  elif(i==2):
    model_lstm.save('/wendianHome/bins/adenhard/multi-step/models/LSTM-BON-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/LSTM-BON-daily.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/LSTM-BON-daily.txt', metrics,  delimiter = ' ')
  elif(i==3):
    model_lstm.save('/wendianHome/bins/adenhard/multi-step/models/LSTM-DRA-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/LSTM-DRA-daily.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/LSTM-DRA-daily.txt', metrics,  delimiter = ' ')
  elif(i==4):
    model_lstm.save('/wendianHome/bins/adenhard/multi-step/models/LSTM-FPK-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/LSTM-FPK-daily.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/LSTM-FPK-daily.txt', metrics,  delimiter = ' ')
  elif(i==5):
    model_lstm.save('/wendianHome/bins/adenhard/multi-step/models/LSTM-GWN-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/LSTM-GWN-daily.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/LSTM-GWN-daily.txt', metrics,  delimiter = ' ')
  elif(i==6):
    model_lstm.save('/wendianHome/bins/adenhard/multi-step/models/LSTM-PSU-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/LSTM-PSU-daily.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/LSTM-PSU-daily.txt', metrics,  delimiter = ' ')
  elif(i==7):
    model_lstm.save('/wendianHome/bins/adenhard/multi-step/models/LSTM-SXF-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/LSTM-SXF-daily.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/LSTM-SXF-daily.txt', metrics,  delimiter = ' ')
  elif(i==8):
    model_lstm.save('/wendianHome/bins/adenhard/multi-step/models/LSTM-TBL-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/LSTM-TBL-daily.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/LSTM-TBL-daily.txt', metrics,  delimiter = ' ')
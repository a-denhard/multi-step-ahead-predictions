...
for i in range(len(monthly_averages)):
  ...
  if (i==0):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-NREL-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-NREL-monthly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-NREL-monthly.txt', metrics,  delimiter = ' ')
  elif(i==1):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-ARM-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-ARM-monthly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-ARM-monthly.txt', metrics,  delimiter = ' ')
  elif(i==2):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-BON-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-BON-monthly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-BON-monthly.txt', metrics,  delimiter = ' ')
  elif(i==3):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-DRA-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-DRA-monthly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-DRA-monthly.txt', metrics,  delimiter = ' ')
  elif(i==4):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-FPK-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-FPK-monthly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-FPK-monthly.txt', metrics,  delimiter = ' ')
  elif(i==5):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-GWN-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-GWN-monthly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-GWN-monthly.txt', metrics,  delimiter = ' ')
  elif(i==6):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-PSU-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-PSU-monthly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-PSU-monthly.txt', metrics,  delimiter = ' ')
  elif(i==7):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-SXF-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-SXF-monthly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-SXF-monthly.txt', metrics,  delimiter = ' ')
  elif(i==8):
    model_lstm.save('/wendianHome/bins/adenhard/one-step/models/LSTM-TBL-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/LSTM-TBL-monthly.txt', predicted_LSTM, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/LSTM-TBL-monthly.txt', metrics,  delimiter = ' ')
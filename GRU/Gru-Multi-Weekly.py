...
for i in range(5, len(weekly_averages)):
  ...
  if (i==0):
    model_GRU.save('/wendianHome/bins/adenhard/multi-step/models/GRU-NREL-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-NREL-weekly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-NREL-weekly.txt', metrics,  delimiter = ' ')
  elif(i==1):
    model_GRU.save('/wendianHome/bins/adenhard/multi-step/models/GRU-ARM-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-ARM-weekly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-ARM-weekly.txt', metrics,  delimiter = ' ')
  elif(i==2):
    model_GRU.save('/wendianHome/bins/adenhard/multi-step/models/GRU-BON-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-BON-weekly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-BON-weekly.txt', metrics,  delimiter = ' ')
  elif(i==3):
    model_GRU.save('/wendianHome/bins/adenhard/multi-step/models/GRU-DRA-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-DRA-weekly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-DRA-weekly.txt', metrics,  delimiter = ' ')
  elif(i==4):
    model_GRU.save('/wendianHome/bins/adenhard/multi-step/models/GRU-FPK-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-FPK-weekly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-FPK-weekly.txt', metrics,  delimiter = ' ')
  elif(i==5):
    model_GRU.save('/wendianHome/bins/adenhard/multi-step/models/GRU-GWN-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-GWN-weekly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-GWN-weekly.txt', metrics,  delimiter = ' ')
  elif(i==6):
    model_GRU.save('/wendianHome/bins/adenhard/multi-step/models/GRU-PSU-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-PSU-weekly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-PSU-weekly.txt', metrics,  delimiter = ' ')
  elif(i==7):
    model_GRU.save('/wendianHome/bins/adenhard/multi-step/models/GRU-SXF-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-SXF-weekly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-SXF-weekly.txt', metrics,  delimiter = ' ')
  elif(i==8):
    model_GRU.save('/wendianHome/bins/adenhard/multi-step/models/GRU-TBL-weekly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-TBL-weekly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-TBL-weekly.txt', metrics,  delimiter = ' ')
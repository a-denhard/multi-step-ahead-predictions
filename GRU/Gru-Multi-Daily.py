...
for i in range(6, len(daily_averages)):  
  ...
  predicted_GRU = inverse_transforms_daily(forecasts_gru, scalar[i], daily_mean[i])
  ...
  if (i==0):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-NREL-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-NREL-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-NREL-daily.txt', metrics,  delimiter = ' ')
  elif(i==1):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-ARM-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-ARM-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-ARM-daily.txt', metrics,  delimiter = ' ')
  elif(i==2):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-BON-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-BON-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-BON-daily.txt', metrics,  delimiter = ' ')
  elif(i==3):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-DRA-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-DRA-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-DRA-daily.txt', metrics,  delimiter = ' ')
  elif(i==4):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-FPK-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-FPK-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-FPK-daily.txt', metrics,  delimiter = ' ')
  elif(i==5):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-GWN-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-GWN-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-GWN-daily.txt', metrics,  delimiter = ' ')
  elif(i==6):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-PSU-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-PSU-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-PSU-daily.txt', metrics,  delimiter = ' ')
  elif(i==7):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-SXF-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-SXF-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-SXF-daily.txt', metrics,  delimiter = ' ')
  elif(i==8):
    model_gru.save('/u/st/am/adenhard/bins/fittedGRU-TBL-daily.h5')
    np.savetxt('/u/st/am/adenhard/bins/forecastsGRU-TBL-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-TBL-daily.txt', metrics,  delimiter = ' ')
...
for i in range(8, len(daily_averages)):  
  ...
  if (i==0):
    model_gru.save('/wendianHome/bins/adenhard/one-step/models/GRU-NREL-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/GRU-NREL-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/GRU-NREL-daily.txt', metrics,  delimiter = ' ')
  elif(i==1):
    model_gru.save('/wendianHome/bins/adenhard/one-step/models/GRU-ARM-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/GRU-ARM-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/GRU-ARM-daily.txt', metrics,  delimiter = ' ')
  elif(i==2):
    model_gru.save('/wendianHome/bins/adenhard/one-step/models/GRU-BON-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/GRU-BON-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/GRU-BON-daily.txt', metrics,  delimiter = ' ')
  elif(i==3):
    model_gru.save('/wendianHome/bins/adenhard/one-step/models/GRU-DRA-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/GRU-DRA-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/GRU-DRA-daily.txt', metrics,  delimiter = ' ')
  elif(i==4):
    model_gru.save('/wendianHome/bins/adenhard/one-step/models/GRU-FPK-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/GRU-FPK-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/GRU-FPK-daily.txt', metrics,  delimiter = ' ')
  elif(i==5):
    model_gru.save('/wendianHome/bins/adenhard/one-step/models/GRU-GWN-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/GRU-GWN-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/GRU-GWN-daily.txt', metrics,  delimiter = ' ')
  elif(i==6):
    model_gru.save('/wendianHome/bins/adenhard/one-step/models/GRU-PSU-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/GRU-PSU-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/GRU-PSU-daily.txt', metrics,  delimiter = ' ')
  elif(i==7):
    model_gru.save('/wendianHome/bins/adenhard/one-step/models/GRU-SXF-daily.h5')
    np.savetxt('/wendianHome/bins/adenhard/one-step/forecasts/GRU-SXF-daily.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/GRU-SXF-daily.txt', metrics,  delimiter = ' ')
  elif(i==8):
    ...
    np.savetxt('/wendianHome/bins/adenhard/one-step/metrics/GRU-TBL-daily.txt', metrics,  delimiter = ' ')

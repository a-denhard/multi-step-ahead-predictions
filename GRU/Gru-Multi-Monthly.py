...
for i in range(len(monthly_averages)):  
  ...
  if (i==0):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-NREL-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-NREL-monthly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-NREL-monthly.txt', metrics,  delimiter = ' ')
  elif(i==1):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-ARM-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-ARM-monthly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-ARM-monthly.txt', metrics,  delimiter = ' ')
  elif(i==2):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-BON-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-BON-monthly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-BON-monthly.txt', metrics,  delimiter = ' ')
  elif(i==3):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-DRA-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-DRA-monthly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-DRA-monthly.txt', metrics,  delimiter = ' ')
  elif(i==4):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-FPK-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-FPK-monthly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-FPK-monthly.txt', metrics,  delimiter = ' ')
  elif(i==5):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-GWN-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-GWN-monthly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-GWN-monthly.txt', metrics,  delimiter = ' ')
  elif(i==6):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-PSU-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-PSU-monthly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-PSU-monthly.txt', metrics,  delimiter = ' ')
  elif(i==7):
    model_gru.save('/wendianHome/bins/adenhard/multi-step/models/GRU-SXF-monthly.h5')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/forecasts/GRU-SXF-monthly.txt', predicted_GRU, delimiter = ' ')
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-SXF-monthly.txt', metrics,  delimiter = ' ')
  elif(i==8):
    ...
    np.savetxt('/wendianHome/bins/adenhard/multi-step/metrics/GRU-TBL-monthly.txt', metrics,  delimiter = ' ')